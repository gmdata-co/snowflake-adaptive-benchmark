...
echo "  duckdb ../../benchmark_results.duckdb -c 'SELECT * FROM platform_comparison_normal;'"
echo "  duckdb ../../benchmark_results.duckdb -c 'SELECT * FROM platform_comparison_coldstart;'"
echo "  duckdb ../../benchmark_results.duckdb -c 'SELECT * FROM platform_comparison_latest;'"
echo ""
